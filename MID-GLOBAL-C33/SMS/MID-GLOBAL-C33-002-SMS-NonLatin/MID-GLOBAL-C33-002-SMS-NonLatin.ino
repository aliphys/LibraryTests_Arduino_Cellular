/**
 * Test Scenario ID : MID-GLOBAL-C33-002-SMS-NonLatin
 * 
 * This sketch sends non-latin text messages to a phone number.
 * 
 * Test Case IDs :
 * MID-GLOBAL-C33-002-SMS-NonLatin-01 -> Send Arabic text
 * MID-GLOBAL-C33-002-SMS-NonLatin-02 -> Send Cyrillic text
 * MID-GLOBAL-C33-002-SMS-NonLatin-03 -> Send Chinese text
 * MID-GLOBAL-C33-002-SMS-NonLatin-04 -> Send Japanese text
 * MID-GLOBAL-C33-002-SMS-NonLatin-05 -> Send Korean text
 * MID-GLOBAL-C33-002-SMS-NonLatin-06 -> Send Hindi text
 * 
 * 
...
const char testScenarioID[] = "MID-GLOBAL-C33-002-SMS-NonLatin";
...
void setup(){
    ...
    Serial.println("MID-GLOBAL-C33-002-SMS-NonLatin-01");
    Serial.println("Send Arabic text...");
    message = "العربية";
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-C33-002-SMS-NonLatin-02");
    Serial.println("Send Cyrillic text...");
    message = "русский";
    Serial.println(message);
    cellular.sendSMS(phoneNumber, message);
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-C33-002-SMS-NonLatin-03");
    Serial.println("Send Chinese text...");
    message = "汉字";
    Serial.println(message);
    cellular.sendSMS(phoneNumber, message);
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-C33-002-SMS-NonLatin-04");
    Serial.println("Send Japanese text...");
    message = "日本語";
    Serial.println(message);
    cellular.sendSMS(phoneNumber, message);
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-C33-002-SMS-NonLatin-05");
    Serial.println("Send Korean text...");
    message = "한글";
    Serial.println(message);
    cellular.sendSMS(phoneNumber, message);
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-C33-002-SMS-NonLatin-06");
    Serial.println("Send Hindi text...");
    message = "हिंदी";
    Serial.println(message);
    cellular.sendSMS(phoneNumber, message);
