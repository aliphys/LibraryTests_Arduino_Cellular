/**
 * Test Scenario ID : MID-GLOBAL-C33-002-SMS-Longetivity
 * 
 * This sketch sends text messages spread over a period of time to a phone number.
 * 
 * Test Case IDs :
 * MID-GLOBAL-C33-002-SMS-Longetivity-01 -> Send 3 texts, with 1 second delay between them
 * MID-GLOBAL-C33-002-SMS-Longetivity-02 -> Send 3 texts, with 10 second delay between them
 * MID-GLOBAL-C33-002-SMS-Longetivity-03 -> Send 3 texts, with 30 second delay between them
 * 
...
const char testScenarioID[] = "MID-GLOBAL-C33-002-SMS-Longetivity";
...
void setup(){
    ...
    Serial.println("MID-GLOBAL-C33-002-SMS-Longetivity-01");
    Serial.println("Send 3 texts, with 1 second delay between them...");
    for (int i = 1; i <= 3; i++) {
        message = String(i) + "/3 1-second delay texts";
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-C33-002-SMS-Longetivity-02");
    Serial.println("Send 3 texts, with 10 second delay between them...");
    for (int i = 1; i <= 3; i++) {
        message = String(i) + "/3 10-second delay texts";
        cellular.sendSMS(phoneNumber, message);
        Serial.println(message);
        delay(1000*10);
    }
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-C33-002-SMS-Longetivity-03");
    Serial.println("Send 3 texts, with 30 second delay between them...");
    for (int i = 1; i <= 3; i++) {
        message = String(i) + "/3 30-second delay texts";
        cellular.sendSMS(phoneNumber, message);
        Serial.println(message);
        delay(1000-30);
    }
