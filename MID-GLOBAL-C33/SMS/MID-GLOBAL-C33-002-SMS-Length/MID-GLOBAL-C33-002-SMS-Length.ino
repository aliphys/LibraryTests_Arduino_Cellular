/**
 * Test Scenario ID : MID-GLOBAL-C33-002-SMS-Length
 * 
 * This sketch sends various SMS character lengths to a phone number.
 * 
 * Test Case IDs :
 * MID-GLOBAL-C33-002-SMS-Length-01 -> Send 0 character SMS
 * MID-GLOBAL-C33-002-SMS-Length-02 -> Send 1 character SMS
 * MID-GLOBAL-C33-002-SMS-Length-03 -> Send 2 character SMS
 * MID-GLOBAL-C33-002-SMS-Length-04 -> Send 69 character SMS
 * MID-GLOBAL-C33-002-SMS-Length-05 -> Send 70 character SMS (Unicode limit)
 * MID-GLOBAL-C33-002-SMS-Length-06 -> Send 71 character SMS
 * MID-GLOBAL-C33-002-SMS-Length-07 -> Send 159 character SMS
 * MID-GLOBAL-C33-002-SMS-Length-08 -> Send 160 character SMS (Unicode limit)
 * MID-GLOBAL-C33-002-SMS-Length-09 -> Send 161 character SMS
 * 
 * 
...
const char testScenarioID[] = "MID-GLOBAL-C33-002-SMS-Length";
...
void setup(){
    ...
    Serial.println("MID-GLOBAL-C33-002-SMS-Length-01");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-C33-002-SMS-Length-02");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-C33-002-SMS-Length-03");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-C33-002-SMS-Length-04");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-C33-002-SMS-Length-05");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-C33-002-SMS-Length-06");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-C33-002-SMS-Length-07");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-C33-002-SMS-Length-08");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-C33-002-SMS-Length-09");
