/**
 * Test Scenario ID : MID-GLOBAL-C33-002-SMS-Emoji
 * 
 * This sketch sends emojis to a phone number.
 * 
 * Test Case IDs :
 * MID-GLOBAL-C33-002-SMS-Emoji-01 -> Send Tears of Joy emoji (😂)
 * MID-GLOBAL-C33-002-SMS-Emoji-02 -> Send Thumbs Up with Medium Skin Tone (👍🏽)
 * MID-GLOBAL-C33-002-SMS-Emoji-03 -> Send Man Cartwheeling (🤸‍♂️)
 * 
 * 
...
const char testScenarioID[] = "MID-GLOBAL-C33-002-SMS-Emoji";
...
void setup(){
    ...
    Serial.println("MID-GLOBAL-C33-002-SMS-Emoji-01");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-C33-002-SMS-Emoji-02");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-C33-002-SMS-Emoji-03");
