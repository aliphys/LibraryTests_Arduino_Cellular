/**
 * Test Scenario ID : MID-GLOBAL-C33-001-Example-RecieveSMS
 * 
 * This sketch demonstrates how to recieve SMS messages using the ArduinoCellular library.
 * 
 * Test Case IDs :
 * MID-GLOBAL-C33-001-Example-RecieveSMS-01 -> Connect to network via SIM card
 * MID-GLOBAL-C33-001-Example-RecieveSMS-02 -> Read unread SMS
 * 
 * 
 * Instructions:
...
const char testScenarioID[] = "MID-GLOBAL-C33-001-Example-RecieveSMS";
...
void setup(){
    ...
    Serial.println("MID-GLOBAL-C33-001-Example-RecieveSMS-01");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-C33-001-Example-RecieveSMS-02");
