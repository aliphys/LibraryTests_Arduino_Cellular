/**
 * Test Scenario ID : MID-GLOBAL-C33-001-Example-LEDControlSMS
 * 
 * This sketch demonstrates how to control the build-in Portenta LED with SMS messages.
 * 
 * Test Case IDs :
 * MID-GLOBAL-C33-001-Example-LEDControlSMS-01 -> Blink LED 3 times upon startup
 * MID-GLOBAL-C33-001-Example-LEDControlSMS-02 -> Turn LED on when sending "on"
 * MID-GLOBAL-C33-001-Example-LEDControlSMS-03 -> Turn LED off when sending "off"
 * 
 * Instructions:
...
const char testScenarioID[] = "MID-GLOBAL-C33-001-Example-LEDControlSMS";
...
void setup(){
    ...
    Serial.println("MID-GLOBAL-C33-001-Example-LEDControlSMS-01");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-C33-001-Example-LEDControlSMS-02");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-C33-001-Example-LEDControlSMS-03");
