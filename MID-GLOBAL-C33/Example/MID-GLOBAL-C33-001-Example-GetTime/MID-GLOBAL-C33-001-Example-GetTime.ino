/**
 * Test Scenario ID : MID-GLOBAL-C33-001-Example-GetTime
 * 
 * This sketch demonstrates how to get the current time from the GPS and cellular network.
 * 
 * Test Case IDs :
 * MID-GLOBAL-C33-001-Example-GetTime-01 -> Connect to GPS
 * MID-GLOBAL-C33-001-Example-GetTime-02 -> Obtain GPS time
 * MID-GLOBAL-C33-001-Example-GetTime-03 -> Get cellular time
 * 
 * Instructions:
...
const char testScenarioID[] = "MID-GLOBAL-C33-001-Example-GetTime";
...
void setup(){
    ...
    Serial.println("MID-GLOBAL-C33-001-Example-GetTime-01");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-C33-001-Example-GetTime-02");
    ...
    if(location.latitude == 0.0 && location.longitude == 0.0){
        ...
        Serial.print("Current GPS time (ISO8601): "); Serial.println(time.getISO8601());
    }

    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-C33-001-Example-GetTime-03");

    Time time = cellular.getCellularTime();
    Serial.print("Current cellular time (ISO8601): "); Serial.println(time.getISO8601());
