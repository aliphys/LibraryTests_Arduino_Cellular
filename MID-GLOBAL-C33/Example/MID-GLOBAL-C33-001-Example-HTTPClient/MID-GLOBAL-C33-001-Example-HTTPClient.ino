/**
 * Test Scenario ID : MID-GLOBAL-C33-001-Example-HTTPClient
 * 
 * This sketch demonstrates how to get the time with the Arduino Pro 4G Module.
 * 
 * Test Case IDs :
 * MID-GLOBAL-C33-001-Example-HTTPClient-01 -> Connect to Network via SIM card
 * MID-GLOBAL-C33-001-Example-HTTPClient-02 -> Perform GET request
 * 
...
const char testScenarioID[] = "MID-GLOBAL-C33-001-Example-HTTPClient";
...
void setup(){
    ...
    Serial.println("MID-GLOBAL-C33-001-Example-HTTPClient-01");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-C33-001-Example-HTTPClient-02");
