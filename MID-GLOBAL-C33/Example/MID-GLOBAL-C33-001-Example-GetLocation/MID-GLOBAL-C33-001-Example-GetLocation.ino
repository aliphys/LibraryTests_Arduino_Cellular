/**
 * Test Scenario ID : MID-GLOBAL-C33-001-Example-GetLocation
 * 
 * This skech demonstrates how to obtain the latitude and longitude using the Arduino_Cellular library.
 * 
 * Test Case IDs :
 * MID-GLOBAL-C33-001-Example-GetLocation-01 -> Connect to GPS
 * MID-GLOBAL-C33-001-Example-GetLocation-02 -> Obtain GPS location
 * 
 * Instructions:
...
const char testScenarioID[] = "MID-GLOBAL-C33-001-Example-GetLocation";
...
void setup(){
    ...
    Serial.println("MID-GLOBAL-C33-001-Example-GetLocation-01");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-C33-001-Example-GetLocation-02");
