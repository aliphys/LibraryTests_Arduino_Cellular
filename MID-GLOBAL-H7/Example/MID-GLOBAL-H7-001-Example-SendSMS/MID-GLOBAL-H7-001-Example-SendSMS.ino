/**
 * Test Scenario ID : MID-GLOBAL-H7-001-Example-SendSMS
 * 
 * This sketch sends text messages to a phone number.
 * 
 * Test Case IDs :
 * MID-GLOBAL-H7-001-Example-SendSMS-01 -> Connect to network via SIM card
 * MID-GLOBAL-H7-001-Example-SendSMS-02 -> Send SMS
 * 
...
const char testScenarioID[] = "MID-GLOBAL-H7-001-Example-SendSMS";
...
void setup(){
    ...
    Serial.println("MID-GLOBAL-H7-001-Example-SendSMS-01");
