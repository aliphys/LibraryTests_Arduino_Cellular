/**
 * Test Scenario ID : MID-GLOBAL-H7-001-Example-DeleteSMS
 * 
 * Via AT commands and the ArduinoCellular library, this sketch demonstrates how create and delete an SMS message.
 * 
 * Test Case IDs :
 * MID-GLOBAL-H7-001-Example-DeleteSMS-01 -> Set Modem to SMS Text Mode
 * MID-GLOBAL-H7-001-Example-DeleteSMS-02 -> Select message storage area
 * MID-GLOBAL-H7-001-Example-DeleteSMS-03 -> Set SMSC number to be stored with text message
 * MID-GLOBAL-H7-001-Example-DeleteSMS-04 -> Write SMS message
 * MID-GLOBAL-H7-001-Example-DeleteSMS-05 -> Read SMS message
 * MID-GLOBAL-H7-001-Example-DeleteSMS-06 -> Delete SMS message
 * 
 * Instructions:
...
const char testScenarioID[] = "MID-GLOBAL-H7-001-Example-DeleteSMS";
...
void setup(){
    ...
    Serial.println("MID-GLOBAL-H7-001-Example-DeleteSMS-01");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-H7-001-Example-DeleteSMS-02");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-H7-001-Example-DeleteSMS-03");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-H7-001-Example-DeleteSMS-04");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-H7-001-Example-DeleteSMS-05");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-H7-001-Example-DeleteSMS-06");
