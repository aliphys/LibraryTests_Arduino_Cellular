 ...
 * 
 * Test Case IDs :
 * MID-GLOBAL-H7-001-Example-ModemTerminal-01 -> Connect to cellular modem (APN)
 * MID-GLOBAL-H7-001-Example-ModemTerminal-02 -> Send AT
 * MID-GLOBAL-H7-001-Example-ModemTerminal-03 -> Send ATE0
 * MID-GLOBAL-H7-001-Example-ModemTerminal-04 -> Send ATE1
 * MID-GLOBAL-H7-001-Example-ModemTerminal-05 -> Send AT+CFUN?
 * MID-GLOBAL-H7-001-Example-ModemTerminal-06 -> Send AT+CPIN?
 * MID-GLOBAL-H7-001-Example-ModemTerminal-07 -> Send AT+CSQ
 * MID-GLOBAL-H7-001-Example-ModemTerminal-08 -> Send AT+CGDCONT?
 * MID-GLOBAL-H7-001-Example-ModemTerminal-09 -> Send AT+CGATT?
 * MID-GLOBAL-H7-001-Example-ModemTerminal-10 -> Send AT+COPS?
 * 
...
const char testScenarioID[] = "MID-GLOBAL-H7-001-Example-ModemTerminal";
...
void setup(){
    ...
    Serial.println("MID-GLOBAL-H7-001-Example-ModemTerminal-01");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-H7-001-Example-ModemTerminal-02");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-H7-001-Example-ModemTerminal-03");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-H7-001-Example-ModemTerminal-04");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-H7-001-Example-ModemTerminal-05");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-H7-001-Example-ModemTerminal-06");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-H7-001-Example-ModemTerminal-07");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-H7-001-Example-ModemTerminal-08");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-H7-001-Example-ModemTerminal-09");
