/**
 * Test Scenario ID : MID-GLOBAL-H7-001-Example-HTTPSClient
 * 
 * This sketch demonstrates how to get the time with the Arduino Pro 4G Module.
 * 
 * Test Case IDs :
 * MID-GLOBAL-H7-001-Example-HTTPSClient-01 -> Connect to Network via SIM card
 * MID-GLOBAL-H7-001-Example-HTTPSClient-02 -> Perform GET request
 * 
...
const char testScenarioID[] = "MID-GLOBAL-H7-001-Example-HTTPSClient";
...
void setup(){
    ...
    Serial.println("MID-GLOBAL-H7-001-Example-HTTPSClient-01");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-H7-001-Example-HTTPSClient-02");
