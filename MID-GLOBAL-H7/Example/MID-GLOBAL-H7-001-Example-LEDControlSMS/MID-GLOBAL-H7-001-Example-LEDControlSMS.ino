/**
 * Test Scenario ID : MID-GLOBAL-H7-001-Example-LEDControlSMS
 * 
 * This sketch demonstrates how to control the build-in Portenta LED with SMS messages.
 * 
 * Test Case IDs :
 * MID-GLOBAL-H7-001-Example-LEDControlSMS-01 -> Blink LED 3 times upon startup
 * MID-GLOBAL-H7-001-Example-LEDControlSMS-02 -> Turn LED on when sending "on"
 * MID-GLOBAL-H7-001-Example-LEDControlSMS-03 -> Turn LED off when sending "off"
 * 
 * Instructions:
...
const char testScenarioID[] = "MID-GLOBAL-H7-001-Example-LEDControlSMS";
...
void setup(){
    ...
    Serial.println("MID-GLOBAL-H7-001-Example-LEDControlSMS-01");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-H7-001-Example-LEDControlSMS-02");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-H7-001-Example-LEDControlSMS-03");
