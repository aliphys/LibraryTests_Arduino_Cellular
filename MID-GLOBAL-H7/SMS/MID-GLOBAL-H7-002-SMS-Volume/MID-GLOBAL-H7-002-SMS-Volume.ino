/**
 * Test Scenario ID : MID-GLOBAL-H7-002-SMS-Volume
 * 
 * This sketch sends multiple SMS messages, without pause, to a phone number.
 * 
 * Test Case IDs :
 * MID-GLOBAL-H7-002-SMS-Volume-01 -> Send 1 text
 * MID-GLOBAL-H7-002-SMS-Volume-02 -> Send 3 texts
 * MID-GLOBAL-H7-002-SMS-Volume-03 -> Send 10 texts
 * 
...
const char testScenarioID[] = "MID-GLOBAL-H7-002-SMS-Volume";
...
void setup(){
    ...
    Serial.println("MID-GLOBAL-H7-002-SMS-Volume-01");
    Serial.println("Send 1 text...");
    message = "Single Text";
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-H7-001-Example-SendSMS-02");

    Serial.println("Send 3 texts...");
    for (int i = 1; i <= 3; i++) {
        message = String(i) + "/3 texts";
        cellular.sendSMS(phoneNumber, message);
        Serial.println(message);
    }
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-GLOBAL-H7-001-Example-SendSMS-03");

    Serial.println("Send 10 texts...");
    for (int i = 1; i <= 10; i++) {
        message = String(i) + "/10 texts";
        cellular.sendSMS(phoneNumber, message);
        Serial.println(message);
    }
