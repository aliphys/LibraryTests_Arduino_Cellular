/**
 * Test Scenario ID : MID-EMEA-H7-001-Example-SendSMS
 * 
 * This sketch sends text messages to a phone number.
 * 
 * Test Case IDs :
 * MID-EMEA-H7-001-Example-SendSMS-01 -> Connect to network via SIM card
 * MID-EMEA-H7-001-Example-SendSMS-02 -> Send SMS
 * 
...
const char testScenarioID[] = "MID-EMEA-H7-001-Example-SendSMS";
...
void setup(){
    ...
    Serial.println("MID-EMEA-H7-001-Example-SendSMS-01");
