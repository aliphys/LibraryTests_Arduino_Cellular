/**
 * Test Scenario ID : MID-EMEA-H7-001-Example-GetLocation
 * 
 * This skech demonstrates how to obtain the latitude and longitude using the Arduino_Cellular library.
 * 
 * Test Case IDs :
 * MID-EMEA-H7-001-Example-GetLocation-01 -> Connect to GPS
 * MID-EMEA-H7-001-Example-GetLocation-02 -> Obtain GPS location
 * 
 * Instructions:
...
const char testScenarioID[] = "MID-EMEA-H7-001-Example-GetLocation";
...
void setup(){
    ...
    Serial.println("MID-EMEA-H7-001-Example-GetLocation-01");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-EMEA-H7-001-Example-GetLocation-02");
