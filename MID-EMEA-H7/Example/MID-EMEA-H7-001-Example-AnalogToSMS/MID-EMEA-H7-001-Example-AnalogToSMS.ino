/**
 * Test Scenario ID : MID-EMEA-H7-001-Example-AnalogToSMS
 * 
 ...
 * 
 * Test Case IDs :
 * MID-EMEA-H7-001-Example-AnalogToSMS-01 -> Send analog pin A0 value once
 * MID-EMEA-H7-001-Example-AnalogToSMS-02 -> Send analog pin A0 value 3 times
 * MID-EMEA-H7-001-Example-AnalogToSMS-02 -> Send analog pin A0 value every 5 seconds for 30 seconds
 * 
...
const char testScenarioID[] = "MID-EMEA-H7-001-Example-AnalogToSMS";
...
void setup(){
    ...
    Serial.println("MID-EMEA-H7-001-Example-AnalogToSMS-01");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-EMEA-H7-001-Example-AnalogToSMS-02");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-EMEA-H7-001-Example-AnalogToSMS-03");
