/**
 * Test Scenario ID : MID-EMEA-H7-001-Example-GetTime
 * 
 * This sketch demonstrates how to get the current time from the GPS and cellular network.
 * 
 * Test Case IDs :
 * MID-EMEA-H7-001-Example-GetTime-01 -> Connect to GPS
 * MID-EMEA-H7-001-Example-GetTime-02 -> Obtain GPS time
 * MID-EMEA-H7-001-Example-GetTime-03 -> Get cellular time
 * 
 * Instructions:
...
const char testScenarioID[] = "MID-EMEA-H7-001-Example-GetTime";
...
void setup(){
    ...
    Serial.println("MID-EMEA-H7-001-Example-GetTime-01");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-EMEA-H7-001-Example-GetTime-02");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-EMEA-H7-001-Example-GetTime-03");
