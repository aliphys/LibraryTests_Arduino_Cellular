/**
 * Test Scenario ID : MID-EMEA-H7-002-SMS-Emoji
 * 
 * This sketch sends emojis to a phone number.
 * 
 * Test Case IDs :
 * MID-EMEA-H7-002-SMS-Emoji-01 -> Send Tears of Joy emoji (😂)
 * MID-EMEA-H7-002-SMS-Emoji-02 -> Send Thumbs Up with Medium Skin Tone (👍🏽)
 * MID-EMEA-H7-002-SMS-Emoji-03 -> Send Man Cartwheeling (🤸‍♂️)
 * 
 * 
...
const char testScenarioID[] = "MID-EMEA-H7-002-SMS-Emoji";
...
void setup(){
    ...
    Serial.println("MID-EMEA-H7-002-SMS-Emoji-01");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-EMEA-H7-002-SMS-Emoji-02");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-EMEA-H7-002-SMS-Emoji-03");
