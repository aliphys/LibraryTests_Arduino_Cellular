/**
 * Test Scenario ID : MID-EMEA-H7-002-SMS-Volume
 * 
 * This sketch sends multiple SMS messages, without pause, to a phone number.
 * 
 * Test Case IDs :
 * MID-EMEA-H7-002-SMS-Volume-01 -> Send 1 text
 * MID-EMEA-H7-002-SMS-Volume-02 -> Send 3 texts
 * MID-EMEA-H7-002-SMS-Volume-03 -> Send 10 texts
 * 
...
const char testScenarioID[] = "MID-EMEA-H7-002-SMS-Volume";
...
void setup(){
    ...
    Serial.println("MID-EMEA-H7-002-SMS-Volume-01");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-EMEA-H7-001-Example-SendSMS-02");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-EMEA-H7-001-Example-SendSMS-03");
