/**
 * Test Scenario ID : MID-EMEA-H7-002-SMS-Longetivity
 * 
 * This sketch sends text messages spread over a period of time to a phone number.
 * 
 * Test Case IDs :
 * MID-EMEA-H7-002-SMS-Longetivity-01 -> Send 3 texts, with 1 second delay between them
 * MID-EMEA-H7-002-SMS-Longetivity-02 -> Send 3 texts, with 10 second delay between them
 * MID-EMEA-H7-002-SMS-Longetivity-03 -> Send 3 texts, with 30 second delay between them
 * 
...
const char testScenarioID[] = "MID-EMEA-H7-002-SMS-Longetivity";
...
void setup(){
    ...
    Serial.println("MID-EMEA-H7-002-SMS-Longetivity-01");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-EMEA-H7-002-SMS-Longetivity-02");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-EMEA-H7-002-SMS-Longetivity-03");
