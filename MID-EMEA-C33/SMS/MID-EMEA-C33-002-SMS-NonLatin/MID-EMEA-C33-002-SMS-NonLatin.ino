/**
 * Test Scenario ID : MID-EMEA-C33-002-SMS-NonLatin
 * 
 * This sketch sends non-latin text messages to a phone number.
 * 
 * Test Case IDs :
 * MID-EMEA-C33-002-SMS-NonLatin-01 -> Send Arabic text
 * MID-EMEA-C33-002-SMS-NonLatin-02 -> Send Cyrillic text
 * MID-EMEA-C33-002-SMS-NonLatin-03 -> Send Chinese text
 * MID-EMEA-C33-002-SMS-NonLatin-04 -> Send Japanese text
 * MID-EMEA-C33-002-SMS-NonLatin-05 -> Send Korean text
 * MID-EMEA-C33-002-SMS-NonLatin-06 -> Send Hindi text
 * 
 * 
...
const char testScenarioID[] = "MID-EMEA-C33-002-SMS-NonLatin";
...
void setup(){
    ...
    Serial.println("MID-EMEA-C33-002-SMS-NonLatin-01");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-EMEA-C33-002-SMS-NonLatin-02");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-EMEA-C33-002-SMS-NonLatin-03");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-EMEA-C33-002-SMS-NonLatin-04");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-EMEA-C33-002-SMS-NonLatin-05");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-EMEA-C33-002-SMS-NonLatin-06");
