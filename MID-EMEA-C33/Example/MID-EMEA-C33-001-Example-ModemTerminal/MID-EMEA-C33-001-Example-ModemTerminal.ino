 ...
 * 
 * Test Case IDs :
 * MID-EMEA-C33-001-Example-ModemTerminal-01 -> Connect to cellular modem (APN)
 * MID-EMEA-C33-001-Example-ModemTerminal-02 -> Send AT
 * MID-EMEA-C33-001-Example-ModemTerminal-03 -> Send ATE0
 * MID-EMEA-C33-001-Example-ModemTerminal-04 -> Send ATE1
 * MID-EMEA-C33-001-Example-ModemTerminal-05 -> Send AT+CFUN?
 * MID-EMEA-C33-001-Example-ModemTerminal-06 -> Send AT+CPIN?
 * MID-EMEA-C33-001-Example-ModemTerminal-07 -> Send AT+CSQ
 * MID-EMEA-C33-001-Example-ModemTerminal-08 -> Send AT+CGDCONT?
 * MID-EMEA-C33-001-Example-ModemTerminal-09 -> Send AT+CGATT?
 * MID-EMEA-C33-001-Example-ModemTerminal-10 -> Send AT+COPS?
 * 
...
const char testScenarioID[] = "MID-EMEA-C33-001-Example-ModemTerminal";
...
void setup(){
    ...
    Serial.println("MID-EMEA-C33-001-Example-ModemTerminal-01");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-EMEA-C33-001-Example-ModemTerminal-02");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-EMEA-C33-001-Example-ModemTerminal-03");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-EMEA-C33-001-Example-ModemTerminal-04");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-EMEA-C33-001-Example-ModemTerminal-05");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-EMEA-C33-001-Example-ModemTerminal-06");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-EMEA-C33-001-Example-ModemTerminal-07");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-EMEA-C33-001-Example-ModemTerminal-08");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-EMEA-C33-001-Example-ModemTerminal-09");
