/**
 * Test Scenario ID : MID-EMEA-C33-001-Example-HTTPSClient
 * 
 * This sketch demonstrates how to get the time with the Arduino Pro 4G Module.
 * 
 * Test Case IDs :
 * MID-EMEA-C33-001-Example-HTTPSClient-01 -> Connect to Network via SIM card
 * MID-EMEA-C33-001-Example-HTTPSClient-02 -> Perform GET request
 * 
...
const char testScenarioID[] = "MID-EMEA-C33-001-Example-HTTPSClient";
...
void setup(){
    ...
    Serial.println("MID-EMEA-C33-001-Example-HTTPSClient-01");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-EMEA-C33-001-Example-HTTPSClient-02");
