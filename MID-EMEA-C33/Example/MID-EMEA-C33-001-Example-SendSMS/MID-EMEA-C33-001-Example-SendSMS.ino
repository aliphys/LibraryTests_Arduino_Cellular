/**
 * Test Scenario ID : MID-EMEA-C33-001-Example-SendSMS
 * 
 * This sketch sends text messages to a phone number.
 * 
 * Test Case IDs :
 * MID-EMEA-C33-001-Example-SendSMS-01 -> Connect to network via SIM card
 * MID-EMEA-C33-001-Example-SendSMS-02 -> Send SMS
 * 
...
const char testScenarioID[] = "MID-EMEA-C33-001-Example-SendSMS";
...
void setup(){
    ...
    Serial.println("MID-EMEA-C33-001-Example-SendSMS-01");
