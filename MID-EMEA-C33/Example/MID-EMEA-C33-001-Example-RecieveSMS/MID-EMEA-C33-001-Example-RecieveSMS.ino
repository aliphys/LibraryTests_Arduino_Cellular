/**
 * Test Scenario ID : MID-EMEA-C33-001-Example-RecieveSMS
 * 
 * This sketch demonstrates how to recieve SMS messages using the ArduinoCellular library.
 * 
 * Test Case IDs :
 * MID-EMEA-C33-001-Example-RecieveSMS-01 -> Connect to network via SIM card
 * MID-EMEA-C33-001-Example-RecieveSMS-02 -> Read unread SMS
 * 
 * 
 * Instructions:
...
const char testScenarioID[] = "MID-EMEA-C33-001-Example-RecieveSMS";
...
void setup(){
    ...
    Serial.println("MID-EMEA-C33-001-Example-RecieveSMS-01");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("MID-EMEA-C33-001-Example-RecieveSMS-02");
